...
export default function HealthcareIndustryPage() {
  return (
    <main className="min-h-screen bg-[radial-gradient(800px_400px_at_10%_10%,rgba(239,68,68,0.06),transparent),radial-gradient(800px_400px_at_90%_20%,rgba(220,38,38,0.06),transparent)]">
      <section className="relative py-20 md:py-28 bg-gradient-to-br from-red-600 via-rose-600 to-pink-600 text-white">
        <div className="max-w-7xl mx-auto px-4 md:px-6 grid gap-10 md:grid-cols-2 md:items-center">
          <div>
            ...
            <p className="mt-4 text-lg md:text-xl text-rose-100 max-w-3xl">
              Connect with providers, payers, and health tech buyers
              compliantly.
            </p>
          ...
          {[
            {
              ...
              desc: "Hospitals and clinics IT and ops.",
              Icon: Stethoscope,
            },
            {
              title: "Payer & Claims",
              desc: "Plans, TPAs, and eligibility.",
              Icon: ShieldCheck,
            },
            {
              title: "Population Health",
              desc: "Engagement and outcomes.",
              Icon: Heart,
            },
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4 md:px-6 rounded-2xl border bg-gradient-to-r from-rose-50 to-pink-50 p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <h2 className="text-2xl md:text-3xl font-bold text-slate-900">
              Grow healthcare pipeline
            </h2>
            <p className="mt-2 text-slate-600">
              HIPAA-aware outreach and compliant messaging frameworks.
            </p>
          </div>
